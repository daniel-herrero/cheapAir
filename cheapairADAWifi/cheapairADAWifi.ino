...
char ssid[] = "KSCHOOL-ALUMNOS";        // your network SSID (name)
char pass[] = "kschool-2017";    // your network password (use for WPA, or use as key for WEP)
...
void publishOnWebServer(float co, float no2, float o3, float g) {
...
//  int g = 1000;
  ...
  publishOnWebServer(co, no2, o3, g);
